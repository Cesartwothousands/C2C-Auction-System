...
INSERT INTO `question` VALUES (1,1,NULL,'I am new to this platform, how can I place a bid on an item?','To place a bid, go to the item page, enter your bid amount.','How to place a bid?','Placing a bid'),(2,2,NULL,'What payment methods are accepted on this platform?','We accept credit cards, debit cards, and PayPal for payments.','Payment methods','Accepted payment methods'),(3,3,NULL,'How are items shipped, and how much does shipping cost?','Shipping costs vary depending on the item and your location. You can find shipping information on the item page.','Shipping and handling','Shipping information'),(4,4,NULL,'What is the refund policy for items purchased on this platform?',NULL,'Refund policy',NULL),(5,5,NULL,'How long do auctions usually last?',NULL,'Auction duration',NULL),(6,1,NULL,'1111111111111',NULL,'1111111111',NULL);
